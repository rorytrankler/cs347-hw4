...
ALTER TABLE per_proj ADD CONSTRAINT per_proj_SIM_Person_FK FOREIGN KEY ( SIM_Person_person_id ) REFERENCES SIM_Person ( person_id ) ;

ALTER TABLE per_proj ADD CONSTRAINT per_proj_Sim_project_FK FOREIGN KEY ( Sim_project_project_id ) REFERENCES Sim_project ( project_id ) ;
